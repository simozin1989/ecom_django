...
class Product(models.Model):
    ...
    PRDImage = models.ImageField(upload_to='images/' , verbose_name=_("Image") , blank=True, null=True)
...
class ProductImage(models.Model):
    ...
    PRDIImage = models.ImageField(upload_to='images/' , verbose_name=_("Image"))
